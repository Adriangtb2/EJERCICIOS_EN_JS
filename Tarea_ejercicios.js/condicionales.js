...
//Ejercicio: alummno que necesita q su promedio sea mayor o igual a 70 o sino reprueba.
    promedioAlum(){
    let not1, not2, not3;
    let promedio;
...
//Ejercicio: en un almacen se hace 20 descuento si supera los $100 ¿cantidad q pagara una persona por su compra?
    pagarDescuento(){
    let comprar;
...
//Ejercicio: leer dos num si son igual multiplica si el primero es mayor q esl segundo los restas y sino sumar
    operacion2Num(){
...
//Ejercicio: elabore un programa donde muestre dias de la semana cuando ingrese los 7 primeros numeros
    diaSem() {
    let dia;
...
//Ejercicio: programa que muestre el significado de aniversario cada década hasta los 60
    significadoAniver(){
    let decada;
