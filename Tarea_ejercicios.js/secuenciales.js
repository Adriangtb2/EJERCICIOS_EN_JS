...
class secuenciales{
//Ejercicio: Calcular la cantidad de seg q estan incluidos en el numero de horas, mins y segs ingresados por el usuario.
  secuencialCantidad(){
  let horas, minutos, seg;
  let horas_seg, minutos_seg, total_seg;
  horas= leer ("digite las horas:");
  minutos= leer ("digite los minutos:");
  segundos= leer ("digites los segundos:");
...
//Ejercicio: Programa para ingresar el radio de un circulo y con area y longitud de circunferencia
  areaLog(){
  let radio, area,lon;
...
//Ejercicio: un maestro desea saber el porcentaje de hombres y de mujeres hay en el grupo de estudiantes.
...
// Ejercicio: Un profe prepara 3 cuestionarios para un final; 5 min en el A, 8 min en el B y 6 en el C.
...
//Ejercicio: descuento de 15% sobre el total de su compra por lo q el cliente desea saber cuanto pagará en total.
  Compra(){
...
//Ejercicio: calificaciones de un alumno: 55% de 3 calif parciales, 30% examfinal y 15% de trabfinal.
  calificacionesAlum(){
  let par1, par2,par3,promedioP,notasparc;
  let examfinal,notexam;
  let notatrabj, notafinaltrabj;
  let notafinal;
  par1,par2,par3= leer ("digite las 3 notas de los parciales:");
